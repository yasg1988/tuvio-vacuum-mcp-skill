...
MCP-сервер из этого репозитория не подключается к Tuya Cloud напрямую. Он вызывает локальный хаб по HTTP. Можно использовать встроенный минимальный хаб из [minimal-hub.md](minimal-hub.md) или свой хаб. По умолчанию используется:
